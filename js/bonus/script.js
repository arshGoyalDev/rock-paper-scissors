...
const computerSelection = document.querySelector('.computer-selection-div');
...
playAgainBtn.forEach(btn => {
  btn.addEventListener('click', () => {
    ...
    userSelection.classList.remove('rock', 'paper', 'scissors', 'lizard', 'spock');
    computerSelection.classList.remove('rock', 'paper', 'scissors', 'lizard', 'spock');
    ...
    let y = document.querySelector('.computer-box').childNodes;
...
function result(input) {
  ...
  compChoices = ['rock', 'paper', 'scissors', 'lizard', 'spock'];
